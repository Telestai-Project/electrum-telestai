...
from electrum_tls.crypto import hash_160
from electrum_tls.bitcoin import var_int, is_segwit_script_type, is_b58_address
from electrum_tls.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, normalize_bip32_derivation
from electrum_tls.i18n import _
from electrum_tls.keystore import Hardware_KeyStore
from electrum_tls.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_tls.wallet import Standard_Wallet
from electrum_tls.util import bfh, versiontuple, UserFacingException
from electrum_tls.logging import get_logger
from electrum_tls.plugin import runs_in_hwd_thread, Device
...
if TYPE_CHECKING:
    from electrum_tls.plugin import DeviceInfo
    from electrum_tls.wizard import NewWalletWizard
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Telestai" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Telestai mode")) from e
                raise e
